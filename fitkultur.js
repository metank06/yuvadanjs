...
$('.page > .container').html(`<div class="alert alert-info"><div class="alert-wrapper"><div class="alert-icon"><div class="icon-box"><i class="fas fa-exclamation-circle"></i></div></div><div class="alert-txt"><p>Deneme dersimizden faydalanabilmeniz için web sitemize ücretsiz üye olmanız gerekmektedir. Henüz üye değilseniz <a href="/signup?return=/s/pilates-deneme-dersi">buraya</a> tıklayarak ücretsiz kayıt olabilirsiniz. </p><p>Daha önce kayıt olduysanız hesabınıza <a href="/login?return=/s/pilates-deneme-dersi">buradan</a> giriş yapmanızı rica ederiz.</p></div></div></div>`);
}else {
